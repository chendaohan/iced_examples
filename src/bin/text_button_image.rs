...
const LENGTH: u8 = 10;
const NUMBERS: [&str; LENGTH as usize] =
    ["零", "一", "二", "三", "四", "五", "六", "七", "八", "九"];
const IMAGES: [&str; LENGTH as usize] = [
...
impl Sandbox for ExampleApp {
    ...
    fn view(&self) -> iced::Element<'_, Self::Message> {
        widget::container(widget::column!(
            widget::text(format!("第{}张图片", NUMBERS[self.current_number as usize]))
                .size(25.0)
                .font(Font {
            ...
            widget::image(image::Handle::from_path(format!(
                "assets/images/{}",
                IMAGES[self.current_number as usize]
            )))
